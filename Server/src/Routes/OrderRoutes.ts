...
import { createOrder, getAllOrders, getUserOrders, updateOrderStatus, getOrderById, deleteOrder, cancelOrder, initiateRefund, retryOrder } from '../Controller/OrderController';
...
router.patch('/:id/cancel', protect as express.RequestHandler, cancelOrder as express.RequestHandler);
router.patch('/:id/refund', protect as express.RequestHandler, authorizeRoles('admin') as express.RequestHandler, initiateRefund as express.RequestHandler);
router.patch('/:id/retry', protect as express.RequestHandler, retryOrder as express.RequestHandler);
