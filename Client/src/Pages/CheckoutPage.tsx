        ...
        <div style={styles.detailsColumn}>
          ...
          {finalPayable > 0 && (
            <div style={styles.cardPanel}>
              ...
              <p style={styles.cardSub}>Choose your preferred payment experience.</p>
          ...
          <div style={styles.promoCard}>
            ...
            <div style={styles.promoGroup}>
              <div style={styles.inlineForm}>
                <InputText placeholder="ENTER COUPON CODE" value={couponInput} onChange={(e) => setCouponInput(e.target.value)} disabled={!!appliedCoupon} style={styles.inlineInput} />
                <Button label={appliedCoupon ? 'Applied' : 'Apply'} onClick={handleApplyCoupon} disabled={!!appliedCoupon || !couponInput.trim()} className="p-button-success" style={styles.inlineBtn} />
              </div>
            ...
            <div style={{ ...styles.promoGroup, marginTop: '1rem' }}>
              <div style={styles.inlineForm}>
                <InputText placeholder="ENTER GIFT CARD CODE" value={giftCardInput} onChange={(e) => setGiftCardInput(e.target.value)} disabled={!!appliedGiftCard} style={styles.inlineInput} />
                <Button label={appliedGiftCard ? 'Applied' : 'Apply'} onClick={handleApplyGiftCard} disabled={!!appliedGiftCard || !giftCardInput.trim()} className="p-button-success" style={styles.inlineBtn} />
              </div>
